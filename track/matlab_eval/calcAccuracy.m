function [AP, AR, AP_all, AP_25, AP_50, AP_75, AR_1, AR_10, AR_100, AR_500] = calcAccuracy(numSeqs, allgt, alldet)
...
AP_all = mean2(AP(evalClass,10:19)); % calculate APmax=0.50:0.95
AP_25 = mean2(AP(evalClass,5)); % calculate APmax=0.50
AP_50 = mean2(AP(evalClass,10)); % calculate APmax=0.50
AP_75 = mean2(AP(evalClass,15)); % calculate APmax=0.75
